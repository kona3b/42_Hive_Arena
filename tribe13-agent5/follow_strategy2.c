...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/24 12:54:53 by kaittola          #+#    #+#             */
/*   Updated: 2022/03/24 15:33:53 by kaittola         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			if (info.row > 0)
			{
				if (info.col < 28)
				{
					if (info.row < 14)
					{
						...
						else if (check_if_type(info, 4, 0) == 1 && info.col > 0)
						{
							return (command_t) {
								.action = MOVE,
								.direction = 4
