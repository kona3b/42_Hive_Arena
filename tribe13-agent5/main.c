...
/*   Updated: 2022/03/24 17:06:15 by kaittola         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
command_t think(agent_info_t info)
{
	...
	if (info.bee == 2)
	{
		...
		return (search_and_destroy(info));
	}
	else if (is_bee_with_flower(bee))
	{
		if (hive_dir >= 0)
		{
			return (command_t) {
...
int main(int argc, char **argv)
{
	...
	char *team_name = "tribe13_agent_5_run_for_your_life";
