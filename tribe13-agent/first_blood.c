	...
	if (info.player == 0)
	{
		if (info.bee == 0)
		{
			if (info.row < 24)
			{
				...
				else if (check_if_type(info, 6, 0) && (check_if_type(info, 4, 1) == 1 || check_if_type(info, 4, 2) == 1 || check_if_type(info, 4, 3) == 1))
				{
					return (command_t) {
						.action = MOVE,
						.direction = 6
			...
			if (info.row < 24)
			{
				if (info.col < 28)
				{
					...
					else if (info.row < 7)
					{
						...
						else if (check_if_type(info, 4, 6) == 1 || check_if_type(info, 3, 4) == 1)
						{
							return (command_t) {
								.action = GUARD,
								.direction = 4
	...
	if (info.player == 1)
	{
		if (info.bee == 0)
		{
			if (info.row < 24)
			{
				...
				else if (check_if_type(info, 2, 0) && (check_if_type(info, 4, 1) == 1 || check_if_type(info, 4, 2) == 1 || check_if_type(info, 4, 4) == 1))
				{
					return (command_t) {
						.action = MOVE,
						.direction = 2
			...
			else if (check_if_type(info, 0, 0) && (check_if_type(info, 2, 1) == 1 || check_if_type(info, 2, 2) == 1 || check_if_type(info, 2, 4) == 1))
			{
				return (command_t) {
					.action = MOVE,
					.direction = 0
