	...
	if (info.player == 0)
	{
		if (info.bee == 0)
		{
			if (info.row < 24)
			{
				...
				else if (check_if_type(info, 6, 0) == 1 && (check_if_type(info, 4, 1) == 1 || check_if_type(info, 4, 2) == 1 || check_if_type(info, 4, 3) == 1))
				{
					return (command_t) {
						.action = MOVE,
						.direction = 6
			...
			else if (check_if_type(info, 0, 0) == 1 && (check_if_type(info, 6, 1) == 1 || check_if_type(info, 6, 2) == 1 || check_if_type(info, 6, 3) == 1))
			{
				return (command_t) {
					.action = MOVE,
					.direction = 0
		...
		if (info.bee == 1)
		{
			if (info.row > 0)
			{
				...
				else if (check_if_type(info, 6, 0) == 1 && (check_if_type(info, 0, 1) == 1 || check_if_type(info, 0, 2) == 1 || check_if_type(info, 0, 3) == 1))
				{
					return (command_t) {
						.action = MOVE,
						.direction = 6
			...
			else if (check_if_type(info, 4, 0) == 1 && (check_if_type(info, 6, 1) == 1 || check_if_type(info, 6, 2) == 1 || check_if_type(info, 6, 3) == 1))
			{
				return (command_t) {
					.action = MOVE,
					.direction = 4
	...
	if (info.player == 1)
	{
		...
		if (info.bee == 1)
		{
			if (info.row > 0)
			{
				...
				else if (check_if_type(info, 2, 0) == 1 && (check_if_type(info, 0, 1) == 1 || check_if_type(info, 0, 2) == 1 || check_if_type(info, 0, 4) == 1))
				{
					return (command_t) {
						.action = MOVE,
						.direction = 2
			...
			else if (check_if_type(info, 4, 0) == 1 && (check_if_type(info, 2, 1) == 1 || check_if_type(info, 2, 2) == 1 || check_if_type(info, 2, 4) == 1))
			{
				return (command_t) {
					.action = MOVE,
					.direction = 4
		...
		if (info.bee == 2)
		{
			...
			else if (check_if_type(info, 4, 0) == 1 && (check_if_type(info, 2, 1) == 1 || check_if_type(info, 2, 2) == 1 || check_if_type(info, 2, 3) == 1))
			{
				return (command_t) {
					.action = MOVE,
					.direction = 4
		...
		if (info.bee == 4)
		{
			if (info.row > 0)
			{
				...
				else if (check_if_type(info, 2, 0) == 1 && (check_if_type(info, 0, 1) == 1 || check_if_type(info, 0, 2) == 1 || check_if_type(info, 0, 3) == 1))
				{
					return (command_t) {
						.action = MOVE,
						.direction = 2
