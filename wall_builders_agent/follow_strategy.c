...
command_t follow_strategy(agent_info_t info)
{
	...
	int player_0_bee_0_row = 10;
	int player_0_bee_0_col = 28;
	int player_0_bee_1_row = 0;
	int player_0_bee_1_col = 10;
	int player_0_bee_2_row = 12;
	int player_0_bee_2_col = 27;
	int player_0_bee_3_row = 29;
	int player_0_bee_3_col = 10;
	int player_0_bee_4_row = 13;
	int player_0_bee_4_col = 28;

	int player_1_bee_0_row = 10;
	int player_1_bee_0_col = 1;
	int player_1_bee_1_row = 0;
	int player_1_bee_1_col = 20;
	int player_1_bee_2_row = 12;
	int player_1_bee_2_col = 2;
	int player_1_bee_3_row = 29;
	int player_1_bee_3_col = 20;
	int player_1_bee_4_row = 13;
	int player_1_bee_4_col = 1;
	...
	if (info.player == 0)
	{
		if (info.bee == 0)
		{
			if (info.row < 24)
			{
				if (info.col < player_0_bee_0_col)
				{
					if (info.row > 3)
					{
						if (info.col < 3)
				...
				else if (check_if_type(info, 4, 0) == 1 && info.row < player_0_bee_0_row)
				{
					return (command_t) {
						.action = MOVE,
						.direction = 4
				...
				else if ((check_if_type(info, 4, 6) == 1 || check_if_type(info, 4, 4) == 1) && info.row < player_0_bee_0_row)
				{
					return (command_t) {
						.action = GUARD,
						.direction = 4
		...
		if (info.bee == 1)
		{
			if (info.row < 24)
			{
				if (info.col < player_0_bee_1_col)
				{
					if (info.row > 10)
					{
						if (info.col < 3)
				...
				else if (check_if_type(info, 4, 0) == 1 && info.row < player_0_bee_1_row)
				{
					return (command_t) {
						.action = MOVE,
						.direction = 4
				...
				else if ((check_if_type(info, 4, 6) == 1 || check_if_type(info, 4, 4) == 1) && info.row < player_0_bee_1_row)
				{
					return (command_t) {
						.action = GUARD,
						.direction = 4
		...
		if (info.bee == 2)
		{
			if (info.col < player_0_bee_2_col)
			{
				if (info.row < 12)
				{
			...
			else if (info.col == player_0_bee_2_col)
			{
				if (info.row == player_0_bee_2_row)
				{
					if (enemy_dir >= 0)
					{
						return (command_t) {
		...
		if (info.bee == 3)
		{
			if (info.row > 0)
			{
				if (info.col < player_0_bee_3_col)
				{
					if (info.row < 14)
					{
						if (info.col < 3)
				...
				else if (check_if_type(info, 0, 0) == 1 && info.row > player_0_bee_3_row)
				{
					return (command_t) {
						.action = MOVE,
						.direction = 0
				...
				else if ((check_if_type(info, 0, 6) == 1 || check_if_type(info, 0, 4) == 1) && info.row > player_0_bee_3_row)
				{
					return (command_t) {
						.action = GUARD,
						.direction = 0
		...
		if (info.bee == 4)
		{
			if (info.row > 0)
			{
				if (info.col < player_0_bee_4_col)
				{
					if (info.row < 21)
					{
						if (info.col < 3)
				...
				else if (check_if_type(info, 0, 0) == 1 && info.row > player_0_bee_4_row)
				{
					return (command_t) {
						.action = MOVE,
						.direction = 0
				...
				else if ((check_if_type(info, 0, 6) == 1 || check_if_type(info, 0, 4) == 1) && info.row > player_0_bee_4_row)
				{
					return (command_t) {
						.action = GUARD,
						.direction = 0
	...
	if (info.player == 1)
	{
		if (info.bee == 0)
		{
			if (info.row < 24)
			{
				if (info.col > player_1_bee_0_col)
				{
					if (info.row > 3)
					{
						if (info.col > 26)
				...
				else if (check_if_type(info, 4, 0) == 1 && info.row < player_1_bee_0_row)
				{
					return (command_t) {
						.action = MOVE,
						.direction = 4
				...
				else if ((check_if_type(info, 4, 6) == 1 || check_if_type(info, 4, 3) == 1) && info.row < player_1_bee_0_row)
				{
					return (command_t) {
						.action = GUARD,
						.direction = 4
		...
		if (info.bee == 1)
		{
			if (info.row < 24)
			{
				if (info.col > player_1_bee_1_col)
				{
					if (info.row > 10)
					{
						if (info.col > 26)
				...
				else if (check_if_type(info, 4, 0) == 1 && info.row < player_1_bee_1_row)
				{
					return (command_t) {
						.action = MOVE,
						.direction = 4
				...
				else if ((check_if_type(info, 4, 6) == 1 || check_if_type(info, 4, 3) == 1) && info.row < player_1_bee_1_row)
				{
					return (command_t) {
						.action = GUARD,
						.direction = 4
		...
		if (info.bee == 2)
		{
			if (info.col > player_1_bee_2_col)
			{
				if (info.row < 12)
				{
			...
			else if (info.col == player_1_bee_2_col)
			{
				if (info.row == player_1_bee_2_row)
				{
					if (enemy_dir1 >= 0)
					{
						return (command_t) {
		...
		if (info.bee == 3)
		{
			if (info.row > 0)
			{
				if (info.col > player_1_bee_3_col)
				{
					if (info.row < 14)
					{
						if (info.col > 26)
				...
				else if (check_if_type(info, 0, 0) == 1 && info.row > player_1_bee_3_row)
				{
					return (command_t) {
						.action = MOVE,
						.direction = 0
				...
				else if ((check_if_type(info, 0, 6) == 1 || check_if_type(info, 0, 3) == 1) && info.row > player_1_bee_3_row)
				{
					return (command_t) {
						.action = GUARD,
						.direction = 0
		...
		if (info.bee == 4)
		{
			if (info.row > 0)
			{
				if (info.col > player_1_bee_4_col)
				{
					if (info.row < 21)
					{
						if (info.col > 26)
				...
				else if (check_if_type(info, 0, 0) == 1 && info.row > player_1_bee_4_row)
				{
					return (command_t) {
						.action = MOVE,
						.direction = 0
				...
				else if ((check_if_type(info, 0, 6) == 1 || check_if_type(info, 0, 3) == 1) && info.row > player_1_bee_4_row)
				{
					return (command_t) {
						.action = GUARD,
						.direction = 0
